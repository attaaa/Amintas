<template>
  <div class="fl-wrapper">
    <div class="fl-header">
      ...
      <img src="img/education_material_prolog4.png" />
    </div>
    ...
    <div class="fl-main">
      ...
      <div class="fl-main--detail">
        <p>
          Banyak hal di keseharian kita yang dapat memicu rasa cemas, dan
          memiliki perasaan itu adalah hal yang normal. Toh manusia memang
          terlahir memiliki perasaan. Namun, kita pun dapat merasa lebih baik
          dengan beragam bantuan tertentu.
        </p>
      </div>
    </div>

    <div class="edukasi-detail--footer" style="padding: 16px">
      <div
      ...
      <div>
        <div
          ...
          @click="$router.push('/materi/detail/p4m1')"
        >
        ...
        <div class="material-item flex items-center">
          <img src="img/education_display_p4m2.png" />
          <div class="text__headline text__primary">
            Penanganan Mandiri
          </div>
        </div>
        <div class="material-item flex items-center">
          <img src="img/education_display_p4m3.png" />
          <div class="text__headline text__primary">
            Strategi Koping
          </div>
        </div>
