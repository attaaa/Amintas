  ...
  <div class="fl-wrapper">
    ...
    <div class="fl-main">
      ...
      <div class="fl-main--detail">
        <p>
          Selayaknya berbagai hal lain di kehidupan kita, setiap perasaan cemas
          mengganggu juga memiliki klasifikasinya sendiri. Memunculkan dampak
          tertentu pada pengidapnya, menunjukkan gejala khas, dan berbagai info
    ...
    <div class="edukasi-detail--footer" style="padding: 16px">
      ...
      <div>
        <div
          ...
          @click="$router.push('/materi/detail/p3m1')"
        >
