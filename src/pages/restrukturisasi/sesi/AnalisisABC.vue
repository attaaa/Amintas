<template>
  <LayoutOne
    headerImg="img/restrukturisasi/bantuan.png"
  ...
  >
    ...
    <p class="text__body text__neutral-black">
      ...
      terlebih dulu perlu mengungkap seperti apa pikiran mengganggu yang muncul.
      Mengingat ia munculnya secara otomatis, cepat, dan spontan. Sehingga kerap
      kali tanpa sadar, perasaan kita telah dipengaruhi oleh pikiran mengganggu
      tersebut.
    </p>
    ...
    <p class="text__body text__neutral-black">
      Kamu telah membuat janji bertemu dengan temanmu. Namun pada saat mendekati
      waktu janjian, temanmu membatalkannya. Kamu merasa tersinggung, sakit
    ...
    <p class="text__body text__neutral-black">
      Pikiran mengganggu seperti itu menunjukkan cara pandang atau pemikiran
      seseorang terkait suatu kejadian, dan pada akhirnya mempengaruhi
      perasaannya.
    </p>
    ...
    <p class="text__special-body">
      “Apa yang terlintas dalam kepala dan pikiranku saat itu?”
    </p>

    <p class="text__body text__neutral-black">
      Jika kamu telah memahaminya, kamu dapat dengan mudah mengungkap pikiran
      mengganggu yang mempengaruhi perasaanmu. Tentunya akan semakin baik, bila
      dibarengi dengan bertambahnya wawasanmu tentang pikiran dan perasaan. Maka
      jangan sungkan untuk memanfaatkan modul ini ya, temanku!
    </p>
  </LayoutOne>
</template>
